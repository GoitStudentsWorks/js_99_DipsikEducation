import{f,a as y,r,t as b,o as k,b as L,c as v}from"./assets/localStorage-5e8ebf11.js";import{i as c}from"./assets/vendor-bbb17a86.js";let d;const g=document.querySelector(".main-category-title");function p(e){const t=e;console.log(e),f(t).then(o=>{Object.keys(o.data).length!==0?(l.innerHTML="",E(o.data,t)):(l.innerHTML="",c.error({message:"Sorry, there are no books to render",position:"topRight"}))}).catch(o=>{console.log("Error loading data:",o),c.info({message:"Sorry, there are no books to render",position:"topRight",timeout:3e3,progressBar:!1,title:"Error"})})}function E(e,t){l.insertAdjacentHTML("afterbegin",'<ul class="category-books-list"></ul>'),d=document.querySelector(".category-books-list");const o=e.map(a=>`
